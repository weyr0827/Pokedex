...
let nationalDex = {
    nationalPokedex: [
        ...
        },
        {
            ...
            metricHeight: 2.0,
            metricWeight: 130.5,
            dexEntry: "Wherever Slaking lives, rings of over a yard in diameter appear in grassy fields. They are made by the Pokémon as it eats all the grass within reach while lying prone on the ground.",
        ...
        },
        {
            ...
            metricHeight: 1.5,
            metricWeight: 84.0,
            dexEntry: "Exploud communicates its feelings to others by emitting whistle-like sounds from the tubes of its body. This Pokémon only raises its voice when it is in battle.",
        ...
        },
        {
            ...
            metricHeight: 0.9,
            metricWeight: 45.5,
            dexEntry: "Tentacool absorbs sunlight and refracts it using water inside its body to convert it into beam energy. This Pokémon shoots beams from its crystal-like eyes.",
        ...
        },
        {
            ...
            metricHeight: 0.6,
            metricWeight: 11.5,
            dexEntry: "Don't be taken by this Pokémon's cute face - it's very dangerous. Mawile fools the foe into letting down its guard then chomps down with its massive jaws. The steel jaws are really horns that have been transformed.",
        ...
        },
        {
            ...
            metricHeight: 2.1,
            metricWeight: 360.0,
            dexEntry: "Aggron is surprisingly protective of its environment. If its mountain is ravaged by a landslide or a fire, this Pokémon will haul topsoil to the area, plant trees, and beautifully restore its own territory.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 31.5,
            dexEntry: "Through the power of meditation, Medicham developed a sixth sense. It gained the ability to use psychokinetic powers. This Pokémon is known to meditate for a whole month without eating.",
        ...
        },
        {
            ...
            metricHeight: 0.8,
            metricWeight: 8.6,
            dexEntry: "From its mouth Gloom drips honey that smells absolutely horrible. Apparently, it loves the horrid stench. It sniffs the noxious fumes and then drips even more of its honey.",
        ...
        },
        {
            ...
            metricHeight: 0.4,
            metricWeight: 5.8,
            dexEntry: "A Bellossom grows flowers more beautifully if it evolves from a smelly Gloom - the stinkier the better. At night, this Pokémon closes its petals and goes to sleep.",
        ...
        },
        {
            ...
            metricHeight: 2.0,
            metricWeight: 130.0,
            dexEntry: "Wailmer can store water inside its body to transform itself into a ball for bouncing on the ground. By filling itself up with more water, this Pokémon can elevate the height of its bounces.",
        ...
        },
        {
            ...
            metricHeight: 0.7,
            metricWeight: 24.0,
            dexEntry: "Numel stores magma of almost 2,200 degrees F within its body. If it gets wet, the magma cools and hardens. In that event, the Pokémon's body grows heavy and its movements become sluggish.",
        ...
        },
        {
            ...
            metricHeight: 0.8,
            metricWeight: 55.0,
            dexEntry: "Magcargo's body temperature is approximately 18,000 degrees F. Water is vaporized on contact. If this Pokémon is caught in the rain, the raindrops instantly turn into steam, cloaking the area in a thick fog.",
        ...
        },
        {
            ...
            metricHeight: 0.6,
            metricWeight: 12.0,
            dexEntry: "Sandshrew has a very dry hide that is extremely tough. The Pokémon can roll into a ball that repels any attack. At night, it burrows into the desert sand to sleep.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 168.0,
            dexEntry: "Lunatone becomes active around the time of the full moon. Instead of walking, it moves by floating in midair using telekinesis. The Pokémon's intimidating red eyes cause all those who see it to become transfixed with fear.",
        ...
        },
        {
            ...
            metricHeight: 6.2,
            metricWeight: 162.0,
            dexEntry: "Milotic live at the bottom of large lakes. When this Pokémon's body glows a vivid pink, it releases a pulsing wave of energy that brings soothing calm to restless spirits.",
        ...
        },
        {
            ...
            metricHeight: 0.3,
            metricWeight: 0.8,
            dexEntry: "Castform borrows the power of nature to transform itself into guises of the sun, rain clouds, and snow clouds. This Pokémon's feelings change with the weather.",
        ...
        },
        {
            ...
            metricHeight: 0.8,
            metricWeight: 30.0,
            dexEntry: "This Pokémon exudes a weak electrical charge from all over its body that makes it take on a slight glow in darkness. Raichu searches for electricity by planting its tail in the ground.",
        ...
        },
        {
            ...
            metricHeight: 1.5,
            metricWeight: 256.5,
            dexEntry: "Glalie has the ability to freely control ice. For example, it can instantly freeze its foe solid. After immobilizing its foe in ice, this Pokémon enjoys eating it in leisurely fashion.",
        ...
        },
        {
            ...
            metricHeight: 0.4,
            metricWeight: 8.0,
            dexEntry: "If Horsea senses danger, it will reflexively spray a dense black ink from its mouth and try to escape. This Pokémon swims by cleverly flapping the fins on its back.",
        ...
        },
        {
            ...
            metricHeight: 1.8,
            metricWeight: 175.0,
            dexEntry: "Regice cloaks itself with frigid air of negative 328 degrees F. Things will freeze solid just by going near this Pokémon. Its icy body is so cold, it will not melt even if it is immersed in magma.",
        ...
        },
        {
            ...
            metricHeight: 4.5,
            metricWeight: 352.0,
            dexEntry: "Kyogre is named in mythology as the Pokémon that expanded the sea by covering the land with torrential rains and towering tidal waves. It took to sleep after a cataclysmic battle with Groudon.",
        ...
        },
        {
            ...
            metricHeight: 3.5,
            metricWeight: 950.0,
            dexEntry: "Groudon has the power to scatter rain clouds and make water evaporate with light and heat. It came as a savior to people who had been suffering from terrible floods.",
        ...
        },
        {
            ...
            metricHeight: 7.0,
            metricWeight: 206.5,
            dexEntry: "Rayquaza is said to have lived for hundreds of millions of years in the earth's ozone layer, above the clouds. Its existence had been completely unknown because it lived so high in the sky.",
