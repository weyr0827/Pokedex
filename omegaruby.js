...
let nationalDex = {
    nationalPokedex: [
        ...
        },
        {
            ...
            metricHeight: 0.4,
            metricWeight: 2.5,
            dexEntry: "Torchic sticks with its Trainer, following behind with unsteady steps. This Pokémon breathes fire of over 1,800 degrees Fahrenheit, including fireballs that leave the foe scorched black.",
        ...
        },
        {
            ...
            metricHeight: 0.8,
            metricWeight: 24.0,
            dexEntry: "Slakoth lolls around for over 20 hours every day. Because it moves so little, it does not need much food. This Pokémon's sole daily meal consists of just three leaves.",
        ...
        },
        {
            ...
            metricHeight: 1.6,
            metricWeight: 55.0,
            dexEntry: "Tentacruel has large red orbs on its head. The orbs glow before lashing the vicinity with a harsh ultrasonic blast. This Pokémon's outburst creates rough waves around it.",
        ...
        },
        {
            ...
            metricHeight: 1.9,
            metricWeight: 220.0,
            dexEntry: "Camerupt has a volcano inside its body. Magma of 18,000 degrees Fahrenheit courses through its body. Occasionally, the humps on this Pokémon's back erupt, spewing the superheated magma.",
        ...
        },
        {
            ...
            metricHeight: 1.1,
            metricWeight: 19.9,
            dexEntry: "Ninetales casts a sinister light from its bright red eyes to gain total control over its foe's mind. This Pokémon is said to live for one thousand years.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 26.6,
            dexEntry: "It freezes foes with an icy breath nearly -60 degrees Fahrenheit. What seems to be its body is actually hollow.",
        ...
        },
        {
            ...
            metricHeight: 1.4,
            metricWeight: 150.6,
            dexEntry: "Walrein's two massively developed tusks can totally shatter blocks of ice weighing 10 tons with one blow. This Pokémon's thick coat of blubber insulates it from subzero temperatures.",
        ...
        },
        {
            ...
            metricHeight: 0.6,
            metricWeight: 95.2,
            dexEntry: "Instead of blood, a powerful magnetic force courses through Beldum's body. This Pokémon communicates with others by sending controlled pulses of magnetism.",
        ...
        },
        {
            ...
            metricHeight: 4.5,
            metricWeight: 352.0,
            dexEntry: "Through Primal Reversion and with nature's full power, it will take back its true form. It can summon storms that cause the sea levels to rise.",
        ...
        },
        {
            ...
            metricHeight: 3.5,
            metricWeight: 950.0,
            dexEntry: "Groudon is said to be the personification of the land itself. Legends tell of its many clashes against Kyogre, as each sought to gain the power of nature.",
        ...
        },
        {
            ...
            metricHeight: 7.0,
            metricWeight: 206.5,
            dexEntry: "Rayquaza is said to have lived for hundreds of millions of years. Legends remain of how it put to rest the clash between Kyogre and Groudon.",
