...
let nationalDex = {
    nationalPokedex: [
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 22.5,
            dexEntry: "It often hides in water to stalk unwary prey. For fast swimming, it moves its ears to maintain balance.",
        ...
        },
        {
            ...
            metricHeight: 0.3,
            metricWeight: 3.2,
            dexEntry: "Often found in forests, eating leaves. It has a sharp stinger on its head that injects poison.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 29.5,
            dexEntry: "It flies at high speed and attacks using the large venomous stingers on its forelegs and tail.",
        ...
        },
        {
            ...
            metricHeight: 0.5,
            metricWeight: 9.0,
            dexEntry: "It stiffens its ears to sense danger. The larger its horns, the more powerful its secreted venom.",
        ...
        },
        {
            ...
            metricHeight: 0.6,
            metricWeight: 7.5,
            dexEntry: "With its magical and cute appeal, it has many admirers. It is rare and found only in certain areas.",
        ...
        },
        {
            ...
            metricHeight: 0.6,
            metricWeight: 9.9,
            dexEntry: "When it is born, it has just one snow-white tail. The tail splits from its tip as it grows older.",
        ...
        },
        {
            ...
            metricHeight: 0.8,
            metricWeight: 7.5,
            dexEntry: "It forms colonies in perpetually dark places and uses ultrasonic waves to identify and approach targets.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 30.0,
            dexEntry: "Lives in the shadows of tall trees where it eats bugs. It is attracted by light at night.",
        ...
        },
        {
            ...
            metricHeight: 1.5,
            metricWeight: 12.5,
            dexEntry: "The dustlike scales covering its wings are color-coded to indicate the kinds of poison it has.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 32.0,
            dexEntry: "Always furious and tenacious to boot. It will not abandon chasing its quarry until it catches up.",
        ...
        },
        {
            ...
            metricHeight: 0.7,
            metricWeight: 19.0,
            dexEntry: "It is very protective of its territory. It will bark and bite to repel intruders from its space.",
        ...
        },
        {
            ...
            metricHeight: 0.6,
            metricWeight: 12.4,
            dexEntry: "Its newly grown legs prevent it from walking well. It appears to prefer swimming over walking.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 56.5,
            dexEntry: "It emits special alpha waves from its body that induce headaches just by being close.",
        ...
        },
        {
            ...
            metricHeight: 1.5,
            metricWeight: 48.0,
            dexEntry: "Its brain can outperform a supercomputer. Its IQ (intelligence quotient) is said to be around 5,000.",
        ...
        },
        {
            ...
            metricHeight: 0.7,
            metricWeight: 4.0,
            dexEntry: "A carnivorous Pokémon that traps and eats bugs. It appears to use its root feet to replenish moisture.",
        ...
        },
        {
            ...
            metricHeight: 1.4,
            metricWeight: 300.0,
            dexEntry: "Its boulder-like body is extremely hard. It can easily withstand dynamite blasts without taking damage.",
        ...
        },
        {
            ...
            metricHeight: 1.6,
            metricWeight: 78.5,
            dexEntry: "The Shellder that latches onto Slowpoke's tail is said to feed on the host's leftover scraps.",
        ...
        },
        {
            ...
            metricHeight: 0.3,
            metricWeight: 6.0,
            dexEntry: "Uses antigravity to stay suspended. Appears without warning and uses Thunder Wave and similar moves.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 60.0,
            dexEntry: "Formed by several Magnemite linked together. They frequently appear when sunspots flare up.",
        ...
        },
        {
            ...
            metricHeight: 1.8,
            metricWeight: 85.2,
            dexEntry: "Uses its three brains to execute complex plans. While two heads sleep, one head is said to stay awake.",
        ...
        },
        {
            ...
            metricHeight: 1.1,
            metricWeight: 90.0,
            dexEntry: "The protruding horn on its head is very hard. It is used for bashing through thick icebergs.",
        ...
        },
        {
            ...
            metricHeight: 1.7,
            metricWeight: 120.0,
            dexEntry: "It stores thermal energy in the body. It swims at a steady eight knots even in intensely cold waters.",
        ...
        },
        {
            ...
            metricHeight: 1.5,
            metricWeight: 40.5,
            dexEntry: "On the night of the full moon, if shadows move on their own and laugh, it must be Gengar's doing.",
        ...
        },
        {
            ...
            metricHeight: 8.8,
            metricWeight: 210.0,
            dexEntry: "As it grows, the stone portions of its body harden to become similar to black-colored diamonds.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 60.0,
            dexEntry: "The larger pincer has 10,000-horsepower crushing force. However, its huge size makes it unwieldy to use.",
        ...
        },
        {
            ...
            metricHeight: 0.4,
            metricWeight: 2.5,
            dexEntry: "It is often mistaken for eggs. When disturbed, they gather quickly and attack in swarms.",
        ...
        },
        {
            ...
            metricHeight: 1.2,
            metricWeight: 9.5,
            dexEntry: "Where two kinds of poison gases meet, two Koffings can fuse into a Weezing over many years.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 35.0,
            dexEntry: "The whole body is swathed with wide vines that are similar to seaweed. The vines sway as it walks.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 54.5,
            dexEntry: "If interrupted while it is miming, it will suddenly DoubleSlap the offender with its broad hands.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 44.5,
            dexEntry: "Its body always burns with an orange glow that enables it to hide perfectly amidst flames.",
        ...
        },
        {
            ...
            metricHeight: 1.5,
            metricWeight: 55.0,
            dexEntry: "If it fails to crush the foe in its pincers, it will swing around and toss the opponent.",
        ...
        },
        {
            ...
            metricHeight: 0.3,
            metricWeight: 4.0,
            dexEntry: "Capable of copying an opponent's genetic code to instantly transform itself into a duplicate of the enemy.",
        ...
        },
        {
            ...
            metricHeight: 0.9,
            metricWeight: 25.0,
            dexEntry: "When storing thermal energy in its body, its temperature can soar to over 1,600 degrees Fahrenheit.",
        ...
        },
        {
            ...
            metricHeight: 1.0,
            metricWeight: 35.0,
            dexEntry: "Despite having strong fangs and tentacles, it went extinct when its heavy shell made it unable to catch prey.",
        ...
        },
        {
            ...
            metricHeight: 0.5,
            metricWeight: 11.5,
            dexEntry: "A Pokémon that was regenerated from a fossil found in what was once the ocean floor long ago.",
        ...
        },
        {
            ...
            metricHeight: 1.3,
            metricWeight: 40.5,
            dexEntry: "Its sleek shape is perfect for swimming. It slashes prey with its claws and drains their fluids.",
        ...
        },
        {
            ...
            metricHeight: 1.8,
            metricWeight: 59.0,
            dexEntry: "A ferocious, prehistoric Pokémon that goes for the enemy's throat with its serrated, sawlike fangs.",
        ...
        },
        {
            ...
            metricHeight: 2.2,
            metricWeight: 210.0,
            dexEntry: "Very few people ever see this Pokémon. Its intelligence is said to match that of humans.",
